...
@Component({
  ...
  templateUrl: './canvas-stereometry-tetrahedron.component.html',
  styleUrls: ['./canvas-stereometry-tetrahedron.component.css'],
  providers: [TetrahedronService]
})
export class CanvasStereometryTetrahedronComponent implements AfterViewInit {
  @ViewChild('canvas')
  ...
  private generateText(arr: { text: string, position: THREE.Vector3 }[]) {
    ...
    let component: CanvasStereometryTetrahedronComponent = this;
